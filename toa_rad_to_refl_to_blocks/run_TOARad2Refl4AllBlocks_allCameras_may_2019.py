...
input_dir_fullpath = "/media/ehsan/6TB_part2/AGU_2021/7228"
...
month_label = 'may_2019_9cam4bands'
num_of_days = 'day1_30'
num_of_paths = 'p1_233'
num_of_blocks = 'b1_46'
...
def main():
	...
	for hdf_counter, hdf_file_fullpath in enumerate(hdf_files_fullpath_list):
		print("processing stat: HDF file (%d/%d)" %(hdf_counter+1, len(hdf_files_fullpath_list)))
		# if day > day_range[1]
