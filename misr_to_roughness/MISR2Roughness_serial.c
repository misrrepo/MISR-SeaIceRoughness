...
int main(int argc, char *argv[]) {
   ...
   // char atmmodel_csvfile[256] = "/home/mare/Projects/MISR/Julienne/IceBridge2016/SeaIce_Jul2016_atmmodel_csvfile2_r025.csv"; // ATM csv file; source from where/
    char atmmodel_csvfile[256] = "/media/ehsan/SEAGATE/april_2016/atmmodel_april_2016_npts_larger40.csv" ; // ATM csv file; source from where/
    ...
    // outputs 
    char predicted_roughness_dir[256] = "/media/ehsan/SEAGATE/p104_o86919_b23/misr2roughness_serial_test_npts_larger40" ; // MISR roughness; rms file; no "/" at the end
