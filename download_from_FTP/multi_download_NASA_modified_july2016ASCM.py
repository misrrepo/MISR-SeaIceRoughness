...
if __name__ == "__main__":
    ...
    starting_url = " https://xfr139.larc.nasa.gov/MISR/Subset_Products/202211142925/"
    ...
    out_dir_label = "july_10_25_2016_ascm"         # our code will create this directory if not available on disk
