// Surf.c
// Read TOA and GMP data, correct for atmosphere using SMAC, save as data and PNG
// Sky Coyote 19 Mar 09
...
if (argc < 6)
	{
	fprintf(stderr, "Usage: Surf toa_data_file gmp_file band output_data_file output_image_file\n");
	return 1;
	}
