...
def main():
	...
	raster_dir_fullpath = "/Users/ehsanmos/MLP_dataset/MISR_polarRasters_ROI_15_july_2016_forLandsat/raster2mosaic"
	...
	output_mosaic_name = 'mosaic_fromVRT_int16_'+resamplingAlg+'_'+date_tag+'.tif'
	...
	my_vrt_ptr = gdal.BuildVRT(VRT_fullpath, 
								files_to_mosaic,
								srcNodata = -99991.0 -99.0,
								VRTNodata = -99991.0 -99.0
								) 					#, options=vrt_options)
